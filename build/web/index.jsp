                ...
                <div class="col-md-6">
                    <form action="cars" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="make" name="make" placeholder="Enter the make of the car" value=${ca.getMake()}>    
                        </div>
                        <div class="form-group">
                            <label for="price">price:</label>
                            <input type="number" step="any" class="form-control" id="price" name="price" placeholder="Enter the price of the car" value=${ca.getPrice()} >    
                        </div>
                        <div class="form-group">
                            <label for="model">model:</label>
                            <input type="text" class="form-control" id="model" name="model" placeholder="Enter the model of the car"value=${ca.getModel()} >    
                        </div>  
                        <div class="form-group">
                            <label for="debut">year:</label>
                            <input type="number" min="2000" max="2017" class="form-control" id="debut" name="debut" placeholder="Enter the year of release of the car" value=${ca.getDebut()}>    
                        </div>  
                        <div class="form-group">
                            <label for="carengine">engine:</label>
                            <input type="text" class="form-control" id="carengine" name="carengine" placeholder="Enter the engine of the car"value=${ca.getCarEngine()} >    
                        </div> 
                        <div class="form-group">
                            <label for="color">color:</label>
                            <input type="text" class="form-control" id="color" name="color" placeholder="Enter the color of the car"value=${ca.getColor()} >    
                        </div> 
                        <div class="form-group">
                            <label for="registration">registration:</label>
                            <input type="text" class="form-control" id="registration" name="regiistration" placeholder="Enter the registration of the car" value=${ca.getRegiistration()}>    
                        </div> 
                        <div class="form-group">
                            <label for="fuel">fuel:</label>
                            <input type="text" maxlength="1" class="form-control" id="fuel" name="fuel" placeholder="Enter the fuel type of the car" value=${ca.getFuel()}>    
                        </div> 
